...
<div class="main_col">
	...
	<h3>Manage Category - Add New Category</h3>
			<br>
			<br>
			...
			<tr></tr>
			<tr>
				<td align="left"><input type="submit" value="Save Category" class="myButton"></td>				
				<td align="right"><a href="allcategories.htm" class="myLink">View All Categories</a>
			</tr>			
